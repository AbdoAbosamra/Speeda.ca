<!DOCTYPE html>
<html lang="<?php echo e(app()->getLocale()); ?>" dir="<?php echo e(in_array(app()->getLocale(), ['ar', 'he', 'ur', 'fa']) ? 'rtl' : 'ltr'); ?>">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="register-language-switcher">
        <div class="language-switcher-standalone" id="languageSwitcherStandalone">
            <button type="button" class="language-btn-standalone" onclick="toggleLanguageMenuStandalone()" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="language-dropdown-standalone" id="languageDropdownStandalone">
                <?php if(app()->getLocale() !== 'en'): ?>
                    <a href="#" onclick="event.preventDefault(); switchLanguageAuth('en');" class="language-option-standalone">
                ...
                <?php if(app()->getLocale() !== 'ar'): ?>
                    <a href="#" onclick="event.preventDefault(); switchLanguageAuth('ar');" class="language-option-standalone">
                        <span class="language-flag-standalone">🇸🇦</span>
                ...
                <?php if(app()->getLocale() !== 'fr'): ?>
                    <a href="#" onclick="event.preventDefault(); switchLanguageAuth('fr');" class="language-option-standalone">
                        <span class="language-flag-standalone">🇫🇷</span>
...
<?php endif; ?>
        ...
        <div class="tab-container" role="tablist">
            <div class="tab active" id="login-tab" role="tab" aria-selected="true" aria-controls="login-panel" tabindex="0"><?php echo e(__('auth.login_tab')); ?></div>
            <div class="tab" id="register-tab" role="tab" aria-selected="false" aria-controls="register-panel" tabindex="0"><?php echo e(__('auth.register_tab')); ?></div>
        </div>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" id="login-form" role="tabpanel" id="login-panel" aria-labelledby="login-tab">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input id="login-field" class="form-input" type="text" name="login" value="<?php echo e(old('login')); ?>" required autofocus autocomplete="username" aria-describedby="login-field-error login-hint">
                ...
                <div class="form-group">
                    ...
                    <div class="role-selection" role="radiogroup" aria-labelledby="role-label">
                        <div class="role-option selected" id="login-client-option" role="radio" aria-checked="true" tabindex="0">
                        ...
                        <div class="role-option" id="login-provider-option" role="radio" aria-checked="false" tabindex="0">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input id="login-password" class="form-input" type="password" name="password" required autocomplete="current-password" aria-describedby="login-password-error">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" id="register-form" style="display: none;" role="tabpanel" id="register-panel" aria-labelledby="register-tab">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input id="name" class="form-input" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus autocomplete="name" aria-describedby="name-error">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input id="register-email" class="form-input" type="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="username" aria-describedby="register-email-error">
                    ...
                    <div class="whatsapp-input-container">
                        ...
                        <div class="whatsapp-input-field">
                            <div class="input-wrapper whatsapp-mobile-input">
                                <input id="mobile" class="form-input" type="tel" name="mobile" value="<?php echo e(old('mobile')); ?>" autocomplete="tel" placeholder="613-520-4877" pattern="[0-9\-\s]{10,20}" minlength="10" maxlength="15" aria-describedby="mobile-error phone-format">
                ...
                <div class="form-group">
                    ...
                    <div class="whatsapp-input-container">
                        ...
                        <div class="whatsapp-input-field">
                            <div class="input-wrapper whatsapp-mobile-input">
                                <input id="whatsapp_number" class="form-input" type="tel" name="whatsapp_number" value="<?php echo e(old('whatsapp_number')); ?>" required autocomplete="tel" placeholder="514-123-4567" aria-describedby="whatsapp-error whatsapp-hint">
                ...
                <div class="form-group">
                    <label class="form-label"><?php echo e(__('auth.profession')); ?></label>
                    <div class="role-selection" role="radiogroup" aria-labelledby="role-label">
                        <div class="role-option selected" id="client-option" role="radio" aria-checked="true" tabindex="0">
                ...
                <div class="form-group profession-field" id="profession-field">
                    ...
                    <div class="custom-select" id="profession-select">
                        <div class="select-trigger" id="profession-trigger">
                            <span class="select-value placeholder" id="profession-value"><?php echo e(__('auth.select_profession')); ?></span>
                ...
                <div class="form-group city-field" id="city-field">
                    ...
                    <div class="custom-select" id="city-select">
                        ...
                        <div class="select-options" id="city-options">
                            ...
                            <div class="select-option" data-value="<?php echo e(__('cities.laval')); ?>"><?php echo e(__('cities.laval')); ?></div>
                            <div class="select-option" data-value="<?php echo e(__('cities.montreal')); ?>"><?php echo e(__('cities.montreal')); ?></div>
                            <div class="select-option" data-value="<?php echo e(__('cities.ottawa')); ?>"><?php echo e(__('cities.ottawa')); ?></div>
                            <div class="select-option" data-value="<?php echo e(__('cities.gatineau')); ?>"><?php echo e(__('cities.gatineau')); ?></div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input id="register-password" class="form-input" type="password" name="password" required autocomplete="new-password" aria-describedby="register-password-error password-strength-text">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input id="password_confirmation" class="form-input" type="password" name="password_confirmation" required autocomplete="new-password" aria-describedby="password-confirmation-error">
                ...
                <div class="terms-container">
                    <div class="checkbox-container">
                        ...
                        <label for="terms" class="checkbox-label">
                            ...
                            <a href="<?php echo e(route('terms-of-service')); ?>" target="_blank" style="color: #667eea; text-decoration: underline; font-weight: 600;"><?php echo e(__('auth.terms_of_service')); ?></a>
                            <?php echo e(__('auth.and')); ?>

                            <a href="<?php echo e(route('privacy-policy')); ?>" target="_blank" style="color: #667eea; text-decoration: underline; font-weight: 600;"><?php echo e(__('auth.privacy_policy')); ?></a>
                        </label>
                    </div>
...
<?php /**PATH Y:\Speeda - Versions\Speeda\resources\views/auth/register.blade.php ENDPATH**/ ?>