...
<head>
    ...
    <title><?php echo e(__('categories.page_title')); ?> - <?php echo e(config('app.name', 'Speeda')); ?></title>
...
<div class="container mt-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><i class="fas fa-home me-1"></i><?php echo e(__('general.home')); ?></a></li>
            <li class="breadcrumb-item"><a href="<?php echo e(route('location')); ?>"><i class="fas fa-map-marker-alt me-1"></i><?php echo e(__('general.locations')); ?></a></li>
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-tags me-1"></i><?php echo e(__('general.categories')); ?></li>
        </ol>
    </nav>
    ...
    <div class="page-header">
        <h1>
            <?php if($selectedCity): ?>
                <?php echo e(__('categories.professional_services_in', ['city' => $selectedCity])); ?>

            <?php else: ?>
                <?php echo e(__('categories.browse_categories')); ?>

            <?php endif; ?>
        </h1>
        <p>
            <?php if($selectedCity): ?>
                <?php echo e(__('categories.find_trusted_in_city', ['city' => $selectedCity])); ?>

            <?php else: ?>
                <?php echo e(__('categories.discover_professionals')); ?>
    ...
    <div class="search-section">
        <div class="row align-items-center">
            <div class="col-md-12">
                <h3 class="mb-3"><?php echo e(__('categories.find_right_professional_title')); ?></h3>
                <p class="mb-4"><?php echo e(__('categories.find_right_professional_desc')); ?></p>

                <!-- Search Form -->
                <form method="GET" action="<?php echo e(route('categories')); ?>" class="mt-4">
                        ...
                        <div class="col-md-8">
                            <div class="input-group input-group-lg">
                                ...
                                <input
                                    ...
                                    placeholder="<?php echo e(__('categories.search_categories_placeholder')); ?>"
                        ...
                        <div class="col-md-4">
                            <div class="d-grid gap-2 d-md-flex">
                                <button type="submit" class="btn btn-light btn-lg flex-fill">
                                    ...
                                    <?php echo e(__('categories.search_button')); ?>

                                </button>
                                <?php if($search): ?>
                                    <a href="<?php echo e(route('categories')); ?>" class="btn btn-outline-light btn-lg">
                                        <i class="fas fa-times me-2"></i>
                                        <?php echo e(__('categories.clear_search')); ?>
                    ...
                    <?php if($selectedCity): ?>
                        <input type="hidden" name="city_id" value="<?php echo e(request()->input('city_id')); ?>">
                    <?php endif; ?>
                </form>
                ...
                <?php if($search): ?>
                    <div class="mt-3">
                        <small class="text-white-50">
                            ...
                            <?php echo e(__('categories.search_results_for', ['query' => $search])); ?>
    ...
    <!-- Quick Navigation -->
    <div class="quick-nav">
        <h4 class="text-center mb-4"><?php echo e(__('categories.quick_navigation')); ?></h4>
        <div class="row">
            <div class="col-md-3 col-6 mb-3">
                <a href="#automotive" class="quick-nav-item">
                    ...
                    <h6><?php echo e(__('categories.automotive')); ?></h6>
                </a>
            </div>
            <div class="col-md-3 col-6 mb-3">
                <a href="#home" class="quick-nav-item">
                    ...
                    <h6><?php echo e(__('categories.home_services')); ?></h6>
                </a>
            </div>
            <div class="col-md-3 col-6 mb-3">
                <a href="#professional" class="quick-nav-item">
                    ...
                    <h6><?php echo e(__('categories.professional')); ?></h6>
                </a>
            </div>
            <div class="col-md-3 col-6 mb-3">
                <a href="#personal" class="quick-nav-item">
                    ...
                    <h6><?php echo e(__('categories.personal_care')); ?></h6>
                </a>
            </div>
        </div>
    </div>
...
<?php endif; ?>
    ...
    <div class="alert location-alert alert-info mb-5">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <strong><?php echo e(__('categories.showing_services_in')); ?> <?php echo e($selectedCity); ?></strong>
            </div>
            <a href="<?php echo e(route('categories')); ?>" class="btn btn-outline-primary btn-sm">
                <i class="fas fa-globe me-1"></i> <?php echo e(__('categories.show_all_cities')); ?>
    ...
    <div class="row mb-5">
        <div class="col-md-3 col-6 mb-3">
            <div class="stat-card">
                <div class="stat-number text-primary"><?php echo e($stats['totalSections'] ?? 0); ?></div>
                <div class="stat-label"><?php echo e(__('categories.stat_service_sections')); ?></div>
            </div>
        </div>
        <div class="col-md-4 col-6 mb-3">
            <div class="stat-card">
                <div class="stat-number text-success"><?php echo e($stats['totalCategories'] ?? 0); ?></div>
                <div class="stat-label"><?php echo e(__('categories.stat_professions')); ?></div>
            </div>
        </div>
        <div class="col-md-4 col-6 mb-3">
            <div class="stat-card">
                <div class="stat-number text-warning"><?php echo e($stats['totalLocations'] ?? 0); ?></div>
                <div class="stat-label"><?php echo e(__('categories.stat_locations')); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="section-card" id="<?php echo e(Str::slug($section->name)); ?>">
        <div class="section-header">
            <div class="section-icon <?php echo e(Str::slug($section->name)); ?>-bg">
                <i class="<?php echo e($section->icon); ?>"></i>
            </div>
            <div class="section-title">
                <h2><?php echo e($section->translated_name); ?></h2>
                <p><?php echo e($section->translated_description); ?></p>
            </div>
        </div>

        <div class="row">
            <?php $__currentLoopData = $section->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                <a href="<?php echo e(route('service-providers.index', ['category' => $category->id, 'city' => $selectedCity])); ?>"
                   class="category-card">
                    <div class="category-icon cat-bg-<?php echo e(($loop->index % 6) + 1); ?>">
                        <i class="<?php echo e($category->icon); ?>"></i>
                    </div>
                    <h4><?php echo e($category->translated_name); ?></h4>
                    <p><?php echo e($category->translated_description); ?></p>
                </a>
            </div>
    ...
    <div class="section-card">
        <div class="empty-state">
            ...
            <h3 class="text-muted mb-3"><?php echo e(__('categories.none_available')); ?></h3>
            <p class="text-muted mb-4"><?php echo e(__('categories.adding_categories_message')); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="section-card text-center">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <h3 class="mb-3"><?php echo e(__('categories.cant_find_what_you_need')); ?></h3>
                <p class="mb-4"><?php echo e(__('categories.help_you_find_message')); ?></p>
                <div class="d-flex justify-content-center gap-3 flex-wrap">
                    <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#suggestionModal">
                        <i class="fas fa-lightbulb me-2"></i> <?php echo e(__('categories.suggest_category')); ?>
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="suggestionModalLabel">
                    ...
                    <?php echo e(__('categories.suggest_new_category')); ?>
                ...
                <form id="suggestionForm">
                    <div class="mb-3">
                        <label for="categoryName" class="form-label fw-bold">
                            ...
                            <?php echo e(__('categories.category_name')); ?>

                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" class="form-control" id="categoryName" placeholder="<?php echo e(__('categories.category_name_placeholder')); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="categoryDescription" class="form-label fw-bold">
                            <i class="fas fa-align-left me-1"></i>
                            <?php echo e(__('categories.description')); ?>

                            <span class="text-muted small">(<?php echo e(__('general.optional')); ?>)</span>
                        </label>
                        <textarea class="form-control" id="categoryDescription" rows="3" placeholder="<?php echo e(__('categories.description_placeholder')); ?>"></textarea>
                    </div>
                    <div class="alert alert-info mb-0">
                        <i class="fab fa-facebook-messenger me-2"></i>
                        <strong><?php echo e(__('categories.note') ?? 'Note'); ?>:</strong>
                        <?php echo e(__('categories.messenger_redirect_info') ?? 'You will be redirected to Messenger to send your suggestion.'); ?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="submitSuggestion()">
                    ...
                    <?php echo e(__('categories.send_via_messenger') ?? __('categories.submit_suggestion')); ?>
...
<!-- Custom JS -->
<script>
    const requiredFieldsMessage = <?php echo json_encode(__('validation.fill_required_fields'), 15, 512) ?>;
    const suggestionSuccessMessage = <?php echo json_encode(__('categories.suggestion_success'), 15, 512) ?>;
    ...
    function submitSuggestion() {
        ...
        const message = `<?php echo e(__('categories.new_category_suggestion') ?? 'New Category Suggestion'); ?>:\n${categoryName}${categoryDescription ? '\n' + categoryDescription : ''}`;
...
<?php /**PATH Y:\Speeda - Versions\Speeda\resources\views/categories.blade.php ENDPATH**/ ?>