    ...
    <div class="container py-4" >
        ...
        <div class="mb-5">
            ...
            <div class="row g-4">
                ...
                <!-- Visitor Analytics -->
                <div class="col-md-4">
                    <a href="<?php echo e(route('admin.visitors')); ?>" class="action-card text-decoration-none d-block p-4 rounded-4 border bg-white shadow-sm">
                        <div class="d-flex align-items-center">
                            <span class="icon-circle bg-purple-soft text-purple me-3">
                                <i class="fas fa-chart-pie"></i>
                            </span>
                            <div class="flex-grow-1">
                                <h6 class="fw-bold mb-1 text-dark"><?php echo e(__('admin.visitor_analytics_label')); ?></h6>
                                <small class="text-secondary"><?php echo e(__('admin.visitor_analytics_description_short')); ?></small>
                            </div>
                            <i class="fas fa-chevron-right text-secondary"></i>
                        </div>
                    </a>
