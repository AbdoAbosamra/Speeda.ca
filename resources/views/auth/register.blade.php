<!DOCTYPE html>
<html lang="{{ app()->getLocale() }}" dir="{{ in_array(app()->getLocale(), ['ar', 'he', 'ur', 'fa']) ? 'rtl' : 'ltr' }}">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="auth-card" id="main-content">
        ...
        <div class="tab-container" role="tablist">
            <div class="tab active" id="login-tab" role="tab" aria-selected="true" aria-controls="login-panel" tabindex="0">{{ __('auth.login_tab') }}</div>
            <div class="tab" id="register-tab" role="tab" aria-selected="false" aria-controls="register-panel" tabindex="0">{{ __('auth.register_tab') }}</div>
        </div>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('login') }}" id="login-form" role="tabpanel" id="login-panel" aria-labelledby="login-tab">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input id="login-field" class="form-input" type="text" name="login" value="{{ old('login') }}" required autofocus autocomplete="username" aria-describedby="login-field-error login-hint">
            ...
            <form method="POST" action="{{ route('register') }}" id="register-form" style="display: none;" role="tabpanel" id="register-panel" aria-labelledby="register-tab">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input id="name" class="form-input" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" aria-describedby="name-error">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input id="register-email" class="form-input" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" aria-describedby="register-email-error">
                    ...
                    <div class="whatsapp-input-container">
                        ...
                        <div class="whatsapp-input-field">
                            <div class="input-wrapper whatsapp-mobile-input">
                                <input id="mobile" class="form-input" type="tel" name="mobile" value="{{ old('mobile') }}" autocomplete="tel" placeholder="613-520-4877" pattern="[0-9\-\s]{10,20}" minlength="10" maxlength="15" aria-describedby="mobile-error phone-format">
                ...
                <div class="form-group">
                    ...
                    <div class="whatsapp-input-container">
                        ...
                        <div class="whatsapp-input-field">
                            <div class="input-wrapper whatsapp-mobile-input">
                                <input id="whatsapp_number" class="form-input" type="tel" name="whatsapp_number" value="{{ old('whatsapp_number') }}" required autocomplete="tel" placeholder="514-123-4567" aria-describedby="whatsapp-error whatsapp-hint">
                ...
                <div class="form-group profession-field" id="profession-field">
                    ...
                    <div class="custom-select" id="profession-select">
                        <div class="select-trigger" id="profession-trigger">
                            <span class="select-value placeholder" id="profession-value">{{ __('auth.select_profession') }}</span>
                ...
                <div class="form-group city-field" id="city-field">
                    ...
                    <div class="custom-select" id="city-select">
                        ...
                        <div class="select-options" id="city-options">
                            ...
                            <div class="select-option" data-value="{{ __('cities.laval') }}">{{ __('cities.laval') }}</div>
                            <div class="select-option" data-value="{{ __('cities.montreal') }}">{{ __('cities.montreal') }}</div>
                            <div class="select-option" data-value="{{ __('cities.ottawa') }}">{{ __('cities.ottawa') }}</div>
                            <div class="select-option" data-value="{{ __('cities.gatineau') }}">{{ __('cities.gatineau') }}</div>
                        </div>
                ...
                <div class="terms-container">
                    <div class="checkbox-container">
                        ...
                        <label for="terms" class="checkbox-label">
                            {{ __('auth.i_agree_to') }}
                            <a href="{{ route('terms-of-service') }}" target="_blank" style="color: #667eea; text-decoration: underline; font-weight: 600;">{{ __('auth.terms_of_service') }}</a>
                            {{ __('auth.and') }}
                            <a href="{{ route('privacy-policy') }}" target="_blank" style="color: #667eea; text-decoration: underline; font-weight: 600;">{{ __('auth.privacy_policy') }}</a>
                        </label>
                    </div>
