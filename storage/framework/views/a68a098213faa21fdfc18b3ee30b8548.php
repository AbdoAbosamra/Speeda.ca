        ...
        <div class="client-search-container">
            ...
            <div class="text-center">
                <p class="client-hero-subtitle"
                    style="font-size: 1rem; font-weight: 700; background: linear-gradient(145deg, #4f46e5, #6366f1); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-color: #eef2ff; display: inline-block; padding: 0.5rem 1.8rem; border-radius: 40px; box-shadow: 0 6px 15px -3px rgba(79,70,229,0.3); letter-spacing: 0.3px; transition: all 0.3s ease; cursor: default;"
                    onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 12px 25px -5px rgba(79,70,229,0.5)';"
                    onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 6px 15px -3px rgba(79,70,229,0.3)';">
            ...
            <div class="client-cta-container">
                ...
                <button class="btn-3d"
                    onclick="window.location.href='<?php echo e(route('register', ['type' => 'service-provider'])); ?>'">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="<?php echo e(route('location')); ?>" class="btn btn-primary btn-lg">
                            ...
                            <a href="<?php echo e(route('register', ['type' => 'service-provider'])); ?>"
                ...
                <div class="col-lg-6 mt-5 mt-lg-0">
                    <img src="<?php echo e(asset('images/banner.png')); ?>" alt="Speeda Services" class="img-fluid hero-image"
                        loading="lazy">
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="benefit-card client-card">
                        ...
                        <div class="promo-badge client-promo">
                            ...
                            <strong><?php echo e(__('home.client_free_forever')); ?></strong>
                            <?php echo e(__('home.client_free_forever_desc')); ?>
                        ...
                        <ul class="benefit-list">
                            <li>
                                ...
                                <div>
                                    <strong><?php echo e(__('home.client_benefit1_title')); ?></strong>
                                    <?php echo e(__('home.client_benefit1_desc')); ?>
                            ...
                            <li>
                                <span class="icon"><i class="fas fa-check-circle"></i></span>
                                <div>
                                    <strong><?php echo e(__('home.client_benefit2_title')); ?></strong>
                                    <?php echo e(__('home.client_benefit2_desc')); ?>
                            ...
                            <li>
                                <span class="icon"><i class="fas fa-check-circle"></i></span>
                                <div>
                                    <strong><?php echo e(__('home.client_benefit3_title')); ?></strong>
                                    <?php echo e(__('home.client_benefit3_desc')); ?>
                            ...
                            <li>
                                <span class="icon"><i class="fas fa-check-circle"></i></span>
                                <div>
                                    <strong><?php echo e(__('home.client_benefit4_title')); ?></strong>
                                    <?php echo e(__('home.client_benefit4_desc')); ?>
                            ...
                            <li>
                                <span class="icon"><i class="fas fa-check-circle"></i></span>
                                <div>
                                    <strong><?php echo e(__('home.client_benefit5_title')); ?></strong>
                                    <?php echo e(__('home.client_benefit5_desc')); ?>
                ...
                <div class="col-lg-6">
                    <div class="benefit-card provider-card">
                        ...
                        <div class="promo-badge provider-promo">
                            ...
                            <strong><?php echo e(__('home.provider_join_free')); ?></strong>
                            <?php echo e(__('home.provider_join_free_desc')); ?>
                        ...
                        <ul class="benefit-list">
                            <li>
                                <span class="icon"><i class="fas fa-check-circle"></i></span>
                                <div>
                                    <strong><?php echo e(__('home.provider_benefit1_title')); ?></strong>
                                    <?php echo e(__('home.provider_benefit1_desc')); ?>
                            ...
                            <li>
                                <span class="icon"><i class="fas fa-check-circle"></i></span>
                                <div>
                                    <strong><?php echo e(__('home.provider_benefit2_title')); ?></strong>
                                    <?php echo e(__('home.provider_benefit2_desc')); ?>
                            ...
                            <li>
                                <span class="icon"><i class="fas fa-check-circle"></i></span>
                                <div>
                                    <strong><?php echo e(__('home.provider_benefit3_title')); ?></strong>
                                    <?php echo e(__('home.provider_benefit3_desc')); ?>
                            ...
                            <li>
                                <span class="icon"><i class="fas fa-check-circle"></i></span>
                                <div>
                                    <strong><?php echo e(__('home.provider_benefit4_title')); ?></strong>
                                    <?php echo e(__('home.provider_benefit4_desc')); ?>
                            ...
                            <li>
                                <span class="icon"><i class="fas fa-check-circle"></i></span>
                                <div>
                                    <strong><?php echo e(__('home.provider_benefit5_title')); ?></strong>
                                    <?php echo e(__('home.provider_benefit5_desc')); ?>
...
</html><?php /**PATH Y:\Speeda - Versions\Speeda\resources\views/home.blade.php ENDPATH**/ ?>