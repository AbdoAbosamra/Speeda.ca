                ...
                <div class="filters-grid">
                    <div class="search-wrapper">
                        ...
                        <input type="text"
                               class="search-input"
                               id="searchInput"
                               placeholder="<?php echo e(__('service_provider.search_providers')); ?>"
                            ...
                            <div class="avatar-container">
                                <?php if($provider->profile_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $provider->profile_image)); ?>"
                                         alt="<?php echo e($provider->company_name ?? $provider->user->name); ?>"
            ...
            <div class="rate-modal-body">
                <form id="rateForm" method="POST" action="<?php echo e(route('reviews.store')); ?>">
                    ...
                    <div class="rating-section">
                        <label class="rating-label"><?php echo e(__('reviews.rating')); ?> <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group mb-4">
                        <label for="review_text" class="form-label"><?php echo e(__('reviews.review_text')); ?> <span class="text-danger">*</span></label>
                        <textarea
                            id="review_text"
                            name="review_text"
                            class="form-control review-textarea"
                            rows="5"
                            placeholder="<?php echo e(__('reviews.review_placeholder')); ?>"
                            required
                            minlength="10"
                            maxlength="1000"
                        ></textarea>
...
<?php /**PATH Y:\Speeda -Test 1\Speeda\resources\views/service-providers/index.blade.php ENDPATH**/ ?>