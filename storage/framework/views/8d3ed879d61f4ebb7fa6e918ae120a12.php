                                                    ...
                                                    <select name="location_id"
                                                        ...
                                                        <?php $__currentLoopData = $locations ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($loc->id); ?>" <?php echo e($serviceProvider->location_id == $loc->id ? 'selected' : ''); ?>>
                                                                <?php echo e($loc->city ?? $loc->name ?? 'Location ' . $loc->id); ?>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-4 text-center">
                                                <div class="rating-big">
                                                    <span class="display-3 fw-bold text-primary"><?php echo e(number_format($reviewStats['average_rating'], 1)); ?></span>
                                                    ...
                                                    <p class="text-muted mt-2"><?php echo e($reviewStats['total_count']); ?> <?php echo e(__('reviews.reviews_total')); ?></p>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                        ...
                                        <div class="review-card" style="background: white; border-radius: 16px; padding: 1.5rem; margin-bottom: 1rem; box-shadow: 0 2px 12px rgba(0,0,0,0.06);">
                                            <div class="review-header" style="display: flex; align-items: center; margin-bottom: 1rem;">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-1 fw-bold"><?php echo e($review->client->name ?? __('reviews.anonymous')); ?></h6>
                                                    <div class="review-rating" style="color: #f59e0b;">
                                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                                            ...
                                                            <?php endif; ?>
                                                        <?php endfor; ?>
                                                        <span class="text-muted ms-2" style="font-size: 0.875rem;"><?php echo e($review->created_at->diffForHumans()); ?></span>
                                                    </div>
                                                </div>
                                            ...
                                            <p class="mb-0" style="color: #4b5563; line-height: 1.6;"><?php echo e($review->review_text); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
            ...
            <div class="col-lg-4">
                <div class="contact-card mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-1 fw-bold"><?php echo e(__('general.email_address')); ?>
                                        ...
                                        <a href="mailto:<?php echo e($serviceProvider->contact_email); ?>"
                                            class="text-decoration-none">
                                            <?php echo e($serviceProvider->contact_email); ?>
                    ...
                    <div class="p-4 bg-light">
                        ...
                        <a href="mailto:<?php echo e($serviceProvider->contact_email); ?>" class="btn btn-outline-primary w-100">
                        ...
                        <div class="card-body p-4">
                            ...
                            <?php if($serviceProvider->category->description): ?>
                                <div>
                                    ...
                                    <p class="mt-1 small text-muted"><?php echo e($serviceProvider->category->description); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-4 text-center">
                            ...
                            <div class="star-rating-input" style="font-size: 2rem; color: #d1d5db; cursor: pointer;">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <i class="fas fa-star rating-star" data-rating="<?php echo e($i); ?>" onclick="setRating(<?php echo e($i); ?>)"></i>
                                <?php endfor; ?>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="reviewText" name="review_text" rows="4"
                                placeholder="<?php echo e(__('reviews.review_placeholder')); ?>" required minlength="10" maxlength="1000"
