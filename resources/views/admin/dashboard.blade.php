...
<div class="admin-content-wrapper" >
    <div class="container py-4" >
        ...
        {{-- Visitor Statistics – refined cards, 6 per row on large screens --}}
        ...
        <div class="mb-5">
            ...
            <div class="row g-4">
                <!-- Manage Locations -->
                <div class="col-md-4">
                    <a href="{{ route('admin.locations') }}" class="action-card text-decoration-none d-block p-4 rounded-4 border bg-white shadow-sm">
                ...
                <!-- Manage Categories -->
                <div class="col-md-4">
                    <a href="{{ route('admin.categories') }}" class="action-card text-decoration-none d-block p-4 rounded-4 border bg-white shadow-sm">
                        <div class="d-flex align-items-center">
                ...
                <!-- Users Management -->
                <div class="col-md-4">
                    <a href="{{ route('admin.users') }}" class="action-card text-decoration-none d-block p-4 rounded-4 border bg-white shadow-sm">
                        <div class="d-flex align-items-center">
        ...
        <div class="mb-5">
            ...
            <div class="row g-4">
                <!-- Pending Reviews -->
                <div class="col-md-4">
                    <a href="{{ route('admin.reviews', ['status' => 'pending']) }}" class="action-card text-decoration-none d-block p-4 rounded-4 border bg-white shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <small class="text-secondary">
                                    @if(($stats['pendingComments'] ?? 0) > 0)
                                        <span class="badge bg-warning bg-opacity-20 text-warning me-1">{{ $stats['pendingComments'] }}</span>
                                        {{ __('admin.awaiting_approval') }}
                                    @else
...
{{-- Modern, Minimal Styles for Dashboard --}}
<style>
