    ...
    <div class="container mt-4">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('location') }}"><i
                            class="fas fa-map-marker-alt me-1"></i>{{ __('general.locations') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page"><i
                        class="fas fa-tags me-1"></i>{{ __('general.categories') }}</li>
            </ol>
        </nav>
                            ...
                            <div class="col-md-8">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" name="search" class="form-control border-start-0 ps-0"
                                        ...
                                        value="{{ $search ?? '' }}" style="font-size: 1.1rem; padding: 0.75rem 1rem;">
                                </div>
                            </div>
                            <div class="col-md-4">
