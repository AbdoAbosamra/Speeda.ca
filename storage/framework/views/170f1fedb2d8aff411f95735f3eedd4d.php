...
<div class="language-switcher" id="languageSwitcher">
    <button type="button" class="language-btn" onclick="toggleLanguageMenu()" aria-haspopup="true" aria-expanded="false">
        <span class="current-language">
            <?php echo e($locales[$currentLocale]['flag']); ?> <?php echo e($locales[$currentLocale]['name']); ?>
    ...
    <div class="language-dropdown" id="languageDropdown" role="menu">
        <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $localeInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($code !== $currentLocale): ?>
                <a href="#"
                   class="language-option"
                   role="menuitem"
                   data-locale="<?php echo e($code); ?>"
                   onclick="event.preventDefault(); switchLanguage('<?php echo e($code); ?>');">
                    <span class="language-flag"><?php echo e($localeInfo['flag']); ?></span>
                    <span class="language-name"><?php echo e($localeInfo['name']); ?></span>
                </a>
            <?php endif; ?>
...
<?php /**PATH Y:\Speeda - Versions\Speeda\resources\views/components/language-switcher.blade.php ENDPATH**/ ?>