...
@include('components.main-nav')
    <div class="container">
        <div class="header">
            @if(app()->getLocale() === 'en')
                <h1><span class="icon">🛡</span> Privacy Policy</h1>
                <p>Speeda.CA Platform Agreement</p>
            @elseif(app()->getLocale() === 'ar')
                <h1><span class="icon">🛡️</span> سياسة الخصوصية — SPEEDA.CA</h1>
                <p>اتفاقية منصة SPEEDA.CA</p>
            @else
                <h1><span class="icon">🛡</span> Politique de Confidentialité</h1>
                <p>Contrat de la plateforme Speeda.CA</p>
            @endif
        </div>
...
@if(app()->getLocale() === 'en')
                ...
                <div class="contact-box">
                    ...
                    <p>Website: <a href="https://speeda.ca" target="_blank">https://speeda.ca</a></p>
                </div>

@elseif(app()->getLocale() === 'ar')
                <!-- Arabic content modified to match the user's request -->
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        ...
                        <p>توضح هذه السياسة كيفية جمعنا واستخدامنا وحمايتنا للمعلومات الشخصية الخاصة بمستخدمي موقعنا الإلكتروني https://speeda.ca ("الموقع")، وتطبيقاتنا المحمولة، والخدمات الرقمية ذات الصلة.</p>
                        <p>تُعد هذه السياسة جزءًا لا يتجزأ من شروط استخدام المنصة. باستخدامك لموقعنا، فإنك تؤكد أنك قد قرأت هذه السياسة وفهمتها ووافقت عليها. إذا لم توافق على أي جزء منها، يُرجى التوقف فورًا عن استخدام المنصة.</p>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        <p>تنطبق هذه السياسة على جميع المستخدمين داخل كندا وخارجها الذين يصلون إلى المنصة أو يستخدمونها. وباستخدام خدماتنا، فإنك توافق على أن يتم جمع ومعالجة وتخزين بياناتك الشخصية في كندا أو في دول أخرى تتمتع بمستوى مماثل من حماية البيانات.</p>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        <p>تعمل SPEEDA كمنصة رقمية وسيطة تربط بين العملاء ومزوّدي الخدمات في بيئة آمنة وموثوقة. لا تُقدّم SPEEDA أي خدمات مباشرة، كما أنها ليست طرفًا في أي عقد أو اتفاق بين العملاء ومزوّدي الخدمات. تُجرى جميع التعاملات والمعاملات بين المستخدمين على مسؤوليتهم الخاصة. ويقتصر دورنا على توفير البنية التقنية التي تُسهّل التواصل بين الأطراف.</p>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        ...
                        <p>ورغم التزامنا بأعلى معايير الأمان، لا يوجد نظام رقمي آمن بنسبة 100%. ويتحمل المستخدمون مسؤولية الحفاظ على سرّية بيانات الدخول الخاصة بهم.</p>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        <p>نحتفظ بمعلوماتك الشخصية فقط للمدة اللازمة لتحقيق الأغراض المذكورة في هذه السياسة أو للامتثال للقوانين (مثل الضرائب أو المحاسبة). وبعد انتهاء فترة الاحتفاظ، تُحذف البيانات أو تُحوّل إلى صيغة مجهولة الهوية.</p>
                        <p>يمكن للمستخدمين طلب حذف بياناتهم في أي وقت عبر البريد الإلكتروني: <a href="mailto:support@speeda.ca">support@speeda.ca</a></p>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        ...
                        <p>يُرجى توجيه الطلبات إلى البريد التالي: <a href="mailto:support@speeda.ca">support@speeda.ca</a></p>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        <p>خدماتنا موجهة للبالغين (18 سنة فما فوق). ولا نقوم بجمع بيانات شخصية من القاصرين دون موافقة الوالدين أو الأوصياء. وفي حال اكتشاف بيانات من هذا النوع، سيتم حذفها نهائيًا.</p>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        <p>قد تُخزّن بياناتك أو تُعالَج على خوادم آمنة تقع في كندا أو الولايات المتحدة الأمريكية. ونحن نلتزم بجميع معايير حماية البيانات الدولية، بما في ذلك القواعد المنظمة لنقل البيانات بين الاتحاد الأوروبي وكندا.</p>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        <p>تحتفظ شركة Bnine General Trading Inc. بالحق في تعديل أو تحديث هذه السياسة في أي وقت. سيتم نشر أي تغييرات على هذه الصفحة مع ذكر تاريخ آخر تحديث. يُعد استمرارك في استخدام المنصة بعد أي تعديل موافقة ضمنية على السياسة المُحدّثة.</p>
                    </div>
                </div>

                <!-- New section 16: Contact Information with icons and exact wording -->
                <div class="section">
                    <h2 class="section-title">
                    ...
                    <div class="section-content">
                        <p>لأي استفسارات أو ملاحظات تتعلق بسياسة الخصوصية، يُرجى التواصل معنا عبر:</p>
                        <div class="contact-box" style="margin-top: 20px;">
                            ...
                            <p>🌐 <a href="https://speeda.ca" target="_blank">https://speeda.ca</a></p>
                        </div>
                    </div>
                </div>

@else
                <!-- French content unchanged -->
                ...
                <div class="contact-box">
                    ...
                    <p>Email: <a href="mailto:support@speeda.ca">support@speeda.ca</a></p>
                    <p>Site Web: <a href="https://speeda.ca" target="_blank">https://speeda.ca</a></p>
                </div>
