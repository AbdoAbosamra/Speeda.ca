...
/**
 * Enhanced Store Category Request
 *
 * CHANGES:
 * 1. English and French names are now required (or show warning)
...
class StoreCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // ✅ CHANGED: English is now required (was nullable)
            'name_en' => [
            ...
            // ✅ CHANGED: French is now required (was nullable)
            'name_fr' => [
                'required', // Changed from 'nullable'
                'string',
                'max:255',
